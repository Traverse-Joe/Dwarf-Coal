...
public class BlockDwarfWallTorch extends BlockDwarfTorch {
    ...
    public  BlockDwarfWallTorch(int lightLevel){
        super(lightLevel);
    ...
    public void randomDisplayTick(BlockState state, World world, BlockPos pos, net.minecraft.util.math.random.Random random) {
        ...
        double var8 = (double)pos.getY() + 0.4D;
        double var10 = (double)pos.getZ() + 0.5D;
        double var12 = 0.22D;
        double var14 = 0.27D;
        Direction var16 = var5.getOpposite();
        world.addParticle(ParticleTypes.SMOKE, var6 + 0.36D * (double)var16.getOffsetX(), var8 + 0.22D, var10 + 0.36D * (double)var16.getOffsetZ(), 0.0D, 0.0D, 0.0D);
        world.addParticle(ParticleTypes.FLAME, var6 + 0.36D * (double)var16.getOffsetX(), var8 + 0.22D, var10 + 0.36D * (double)var16.getOffsetZ(), 0.0D, 0.0D, 0.0D);
    }
